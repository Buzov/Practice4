 ...
 * @author Artur Buzov
 */
public class CustomerDaoMatrixH2 extends CustomerDAOAbstract {
     ...
     * @throws SQLException
     */
    public CustomerDaoMatrixH2(Connection connection) throws SQLException {
        super(connection);
    }
    ...
    public void insert(Matrix matrix, int matrix_id) throws SQLException {
        ...
        /*String createBase = "CREATE DATABASE IF NOT EXISTS `practice`;\n"
                + "`CREATE IF NOT EXISTS TABLE `matrix` ( \n"
                ...
                + "`matrix_first` BLOB  NOT NULL , \n"
                + "`matrix_second` BLOB  NOT NULL , \n"
                + "`matrix_result` BLOB NOT NULL , \n"
                + "PRIMARY KEY (`id`) );";
